...
var LabelPlugin = (function () {
  var LabelPlugin = function () {
    ...
    // self.Parameters.PluginWidth = self.addPluginParameters("PluginWidth", "input", "auto", "Plugin Width", "Set width in pixels. It works only when 'multiple lines' parameter is checked");
  ...
  LabelPlugin.prototype.Draw = function (WorkSpace) {
    ...
    p.style.fontFamily = this.GetParameterByName("FontFamily").SelectedValue;
